...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FirebaseErrorModel error) loginError,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(FirebaseErrorModel error)? loginError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class LoginError<T> implements LoginState<T> {
  const factory LoginError(final FirebaseErrorModel error) =
      _$LoginErrorImpl<T>;
