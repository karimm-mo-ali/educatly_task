...
mixin _$SignupState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FirebaseErrorModel error) signupError,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(FirebaseErrorModel error)? signupError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$SignupErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({FirebaseErrorModel error});
}
...
abstract class SignupError<T> implements SignupState<T> {
  const factory SignupError(final FirebaseErrorModel error) =
      _$SignupErrorImpl<T>;

  FirebaseErrorModel get error;
